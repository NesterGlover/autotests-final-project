...
class LoginPage(BasePage):
    ...
    def should_be_login_form(self):
        ...
        assert login_email and login_password, \
        "Login form is not fully presented!"
    ...
    def should_be_register_form(self):
        ...
        assert register_email and register_pass1 and register_pass2, \
            "Register form is not fully presented!"